...
public class ProjectCompleterFactory {
	...
	public static List<Completer> getProjectCompleters(Project project) {
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("show"), new StringsCompleter("report"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("show"), new StringsCompleter("chart"),
				new StringsCompleter("process_control", "burn_down", "cumulative_flow", "cycle_time_distribution"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("past"), new StringsCompleter("releases"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("past"), new StringsCompleter("sprints"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("future"), new StringsCompleter("releases"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("future"), new StringsCompleter("sprints"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("current"), new StringsCompleter("sprints"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("closed"), new StringsCompleter("alerts"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("closed"), new StringsCompleter("bugs"),
				new StringsCompleter("filter", "sort"), new NullCompleter()));
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("tasks"), new StringsCompleter("filter", "sort"),
				new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("tests"), new StringsCompleter("filter", "sort"),
				new NullCompleter()));

		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("times"), new StringsCompleter("filter", "sort"),
				new NullCompleter()));

		completers.add(
				new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("bugs"), new StringsCompleter("filter", "sort"), new NullCompleter()));
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("go_to"),
				new StringsCompleter("backlog", "releases", "sprints", "tasks", "tests", "bugs", "planner"), new NullCompleter()));
