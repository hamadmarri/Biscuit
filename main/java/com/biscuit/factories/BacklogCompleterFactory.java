...
public class BacklogCompleterFactory {
	...
	public static List<Completer> getBacklogCompleters(Backlog backlog) {
		...
		completers.add(
				new ArgumentCompleter(new StringsCompleter("summary", "user_stories", "back"), new NullCompleter()));
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("list"), new StringsCompleter("open"),
				new StringsCompleter("user_stories"), new StringsCompleter("filter", "sort"), new NullCompleter()));
		...
		completers.add(new ArgumentCompleter(new StringsCompleter("go_to"),
				new StringsCompleter(UserStory.getUserStories(backlog)), new NullCompleter()));
